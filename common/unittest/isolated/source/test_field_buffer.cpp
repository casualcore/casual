...
const auto FLD_SHORT1 = CASUAL_FIELD_SHORT * 0x200000 + 1;
const auto FLD_SHORT2 = CASUAL_FIELD_SHORT * 0x200000 + 2;
const auto FLD_SHORT3 = CASUAL_FIELD_SHORT * 0x200000 + 3;

const auto FLD_LONG1 = CASUAL_FIELD_LONG * 0x200000 + 1;
const auto FLD_LONG2 = CASUAL_FIELD_LONG * 0x200000 + 2;
const auto FLD_LONG3 = CASUAL_FIELD_LONG * 0x200000 + 3;

const auto FLD_CHAR1 = CASUAL_FIELD_CHAR * 0x200000 + 1;
const auto FLD_CHAR2 = CASUAL_FIELD_CHAR * 0x200000 + 2;
const auto FLD_CHAR3 = CASUAL_FIELD_CHAR * 0x200000 + 3;

const auto FLD_FLOAT1 = CASUAL_FIELD_FLOAT * 0x200000 + 1;
const auto FLD_FLOAT2 = CASUAL_FIELD_FLOAT * 0x200000 + 2;
const auto FLD_FLOAT3 = CASUAL_FIELD_FLOAT * 0x200000 + 3;

const auto FLD_DOUBLE1 = CASUAL_FIELD_DOUBLE * 0x200000 + 1;
const auto FLD_DOUBLE2 = CASUAL_FIELD_DOUBLE * 0x200000 + 2;
const auto FLD_DOUBLE3 = CASUAL_FIELD_DOUBLE * 0x200000 + 3;

const auto FLD_STRING1 = CASUAL_FIELD_STRING * 0x200000 + 1;
const auto FLD_STRING2 = CASUAL_FIELD_STRING * 0x200000 + 2;
const auto FLD_STRING3 = CASUAL_FIELD_STRING * 0x200000 + 3;

const auto FLD_BINARY1 = CASUAL_FIELD_BINARY * 0x200000 + 1;
const auto FLD_BINARY2 = CASUAL_FIELD_BINARY * 0x200000 + 2;
const auto FLD_BINARY3 = CASUAL_FIELD_BINARY * 0x200000 + 3;
