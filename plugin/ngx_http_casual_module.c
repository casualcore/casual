...
static char* ngx_http_casual_merge_loc_conf(ngx_conf_t *cf,
...
ngx_module_t  ngx_http_casual_module = {
    NGX_MODULE_V1,
...
static ngx_int_t
ngx_http_casual_handler(ngx_http_request_t *r)
{
    ngx_log_debug(NGX_LOG_DEBUG_ALL, r->connection->log, 0,"ngx_http_casual_handler.\n");
...
static ngx_int_t
ngx_http_casual_init(ngx_http_casual_loc_conf_t *cglcf)
{
