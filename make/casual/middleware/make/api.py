...
def LinkServer( name, objects, libraries, serverdefinition, resources=None, configuration=None):
   ...
   full_executable_name = api.make_build_absolute_path(selector.expanded_executable_name(name, directory))
   ...
   arguments = {
      ...
      'objects' : objects, 
      'libraries': libraries, 
      'library_paths': api.get_library_paths( makefile.filename()), 
      'include_paths': api.get_include_paths( makefile.filename()), 
      'directive': directive
      }
