            ...
            */
            ...
            namespace send
            {
               auto lookup( const communication::ipc::inbound::Device& ipc, const std::string& service)
               {
                  ...
                  lookup.context = decltype( lookup.context)::no_busy_intermediate;
            ...
            namespace policy
            {
               struct Service
               {
                  static message::service::call::callee::Request transform( Request request)
                  {
                     ...
                     result.buffer.memory = std::move( request.payload.body);
                  ...
                  static Reply transform( message::service::call::Reply reply)
                  {
                     ...
                     Reply result;
                     result.payload.body = std::move( reply.buffer.memory);
