	   ...
	   namespace manager
      {
         ...
         namespace handle
         {
            ...
            struct Policy
            {
               ...
               void reply( common::platform::ipc::id id, common::message::service::call::Reply& message);
               ...
               void statistics( common::platform::ipc::id, common::message::event::service::Call&);
