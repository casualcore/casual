         ...
         namespace create
         {
            namespace detail
            {
               ...
               auto create( const std::string& key, M& map, Ts&&... ts)
               {
                  ...
                  {
                     throw serviceframework::exception::Validation{ common::string::compose( "failed to find archive creator for key: ", key)};
                  }
               }
            } // detail
            namespace reader
            {
               ...
               struct basic_dispatch
               {
                  ...
                  bool registration( std::vector< std::string> keys)
                  {
                     auto creator = []( auto& source){
                        return archive::Reader::emplace< policy_type< I>>( source);
                     };
                  ...
                  archive::Reader create( const std::string& key, std::istream& input) { return detail::create( key, m_creators, input);}
                  archive::Reader create( const std::string& key, const platform::binary::type& input) { return detail::create( key, m_creators, input);}
               ...
               private:
                  ...
                  struct Base 
                  {
                     ...
                     virtual archive::Reader create( std::istream& stream) const  = 0;
                     virtual archive::Reader create( const platform::binary::type& data) const = 0;
                  };
                  ...
                  struct Model : Base
                  {
                     ...
                     archive::Reader create( std::istream& stream) const override 
                     { 
                        return m_creator( stream);
                     }
                     archive::Reader create( const platform::binary::type& data) const override { return m_creator( data);}
               ...
               namespace consumed 
               {
                  ...
                  using Dispatch = basic_dispatch< archive::policy::Consumed>;
               ...
               namespace strict 
               {
                  ...
                  using Dispatch = basic_dispatch< archive::policy::Strict>;
               ...
               namespace relaxed 
               {
                  ...
                  using Dispatch = basic_dispatch< archive::policy::Relaxed>;
            ...
            namespace writer
            {
               namespace detail
               {
                     ...
                     std::enable_if_t< common::traits::detect::is_detected< has_output_ctor, I, D>::value>>
                  {
                     ...
                     {
                        return archive::Writer::emplace< I>( destination);
                     }
                  };
                     ...
                     std::enable_if_t< ! common::traits::detect::is_detected< has_output_ctor, I, D>::value>>
                  {
                     static auto create( D& destination)
                     {
                        return archive::Writer::emplace< Flusher< std::decay_t< D>, I>>( destination);
                     }
                  };
               ...
               template< typename I, typename D>
               archive::Writer holder( D& destination)
               {
               ...
               struct Dispatch
               {
                  ...
                  archive::Writer create( const std::string& key, std::ostream& stream);
                  archive::Writer create( const std::string& key, platform::binary::type& data);
               ...
               private:
                  ...
                  {
                     virtual ~Base() = default;
                     virtual archive::Writer create( std::ostream& stream) const  = 0;
                     virtual archive::Writer create( platform::binary::type& data) const = 0;
                  };
                  ...
                  struct Model : Base
                  {
                     ...
                     archive::Writer create( std::ostream& stream) const override { return m_creator( stream);}
                     archive::Writer create( platform::binary::type& data) const override  { return m_creator( data);}
