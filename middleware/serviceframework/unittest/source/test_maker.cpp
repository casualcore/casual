...
/*
   TEST( casual_sf_maker, sandbox)
   {
      ...
      auto w = serviceframework::archive::writer::from::name( "ini");
...
*/
   ...
   TEST( casual_sf_maker, decuce_archive_from_yml_input__expecting_success)
   {
      ...
      {
         auto w = serviceframework::archive::writer::from::name( stream, "yml");
         w << CASUAL_MAKE_NVP( banana);
      }
      ...
      EXPECT_NO_THROW
      ({
         serviceframework::archive::reader::from::data( stream);
      });
   }
   ...
   TEST( casual_sf_maker, decuce_archive_from_xml_input__expecting_success)
   {
      ...
      {
         auto w = serviceframework::archive::writer::from::name( stream, "xml");
         w << CASUAL_MAKE_NVP( banana);
      }
   ...
   TEST( casual_sf_maker, decuce_archive_from_jsn_input__expecting_success)
   {
      ...
      {
         auto w = serviceframework::archive::writer::from::name( stream, "jsn");
         w << CASUAL_MAKE_NVP( banana);
      }
   ...
   TEST( casual_sf_maker, decuce_archive_from_ini_input__expecting_success)
   {
      ...
      {
         auto w = serviceframework::archive::writer::from::name( stream, "ini");
         w << CASUAL_MAKE_NVP( banana);
      }
   ...
   TEST( casual_sf_maker, read_from_non_existing_file__expecting_exception)
   {
      EXPECT_THROW
      ({
         serviceframework::archive::reader::from::file( common::file::name::unique( common::directory::temporary() + "/", ".ini"));
   ...
   TEST( casual_sf_maker, write_and_read_file__expecting_success)
   {
      ...
      long source = 42;
      {
         ...
         auto w = serviceframework::archive::writer::from::file( path);
      ...
      {
         local::Banana banana;
         auto r = serviceframework::archive::reader::from::file( path);
   ...
   TEST( casual_sf_maker, write_and_read_buffer__expecting_success)
   {
      ...
      long source = 42;
      {
         ...
         auto w = serviceframework::archive::writer::from::buffer( buffer, "json");
         w << CASUAL_MAKE_NVP( banana);
      }
      ...
      {
         local::Banana banana;
         auto r = serviceframework::archive::reader::from::buffer( buffer, "json");
         r >> CASUAL_MAKE_NVP( banana);
   ...
   TEST( casual_sf_maker, make_writer_from_unknown_archive__expecting_exception)
   {
      ...
      EXPECT_THROW(
      {
         serviceframework::archive::writer::from::name( std::cout, "foo");
   ...
   TEST( casual_sf_maker, make_writer_with_capital_letters__expecting_success)
   {
      ...
      EXPECT_NO_THROW(
      {
         serviceframework::archive::writer::from::name( "XML");
      });
   ...
   TEST( casual_sf_maker, write_and_read_some__expecting_equality)
   {
      ...
      {
         local::Banana banana;
         auto r = serviceframework::archive::reader::from::name( stream, "ini");
