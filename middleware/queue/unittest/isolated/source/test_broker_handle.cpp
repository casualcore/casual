...
namespace casual
{
   namespace queue
   {
         ...
         namespace
         {
            ...
            common::communication::ipc::dispatch::Handler handler( State& state)
            {
               return {
                  ...
                  broker::handle::domain::discover::Request{ state.state},
      ...
      TEST( casual_queue_broker_handle, lookup_request)
      {
      ...
      TEST( casual_queue_broker_handle, domain_advertise_queueX__expect_added_queueX)
      {
         common::unittest::Trace trace;
...

         {
            ...
            auto found = common::range::find_if( state.state.gateways, [&]( const broker::State::Gateway& g){
      ...
      TEST( casual_queue_broker_handle, pending_for_queueX__domain_advertise_queueX__expect_lookup_reply)
      {
         common::unittest::Trace trace;
