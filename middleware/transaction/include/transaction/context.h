...
namespace casual
{
   namespace transaction
   {
      ...
      struct Context
      {
         ...
         //! @{
         [[nodiscard]] code::ax resource_registration( resource::id rmid, XID* xid);
         [[nodiscard]] code::ax resource_unregistration( resource::id rmid);
         //! @}
         ...
         void update( common::message::service::call::Reply& state);

         //! commits or rollback transaction created from this server
         common::message::service::transaction::State finalize( bool commit);
         ...
         [[nodiscard]] std::vector< resource::id> resources() const noexcept;
      ...
      private:
         ...
         [[nodiscard]] code::tx resource_commit( resource::id rm, const Transaction& transaction, common::flag::xa::Flag flags);
