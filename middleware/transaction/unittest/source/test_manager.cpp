...
domain:
   ...
   transaction:
      ...
      TEST( transaction_manager, resource_disassociate__resource_not_involved___expect_direct_reply)
      {
         ...
         {
            common::message::transaction::resource::external::disassociate::Request message{ resource.handle()};
            auto correlation = local::send::tm( message);


            auto reply = common::communication::device::receive< common::message::transaction::resource::external::disassociate::Reply>( resource.device);
      ...
      TEST( transaction_manager, resource_disassociate__resource_involved___expect_reply_after_rollback)
      {
         ...
         // send disassociate message
         {
            common::message::transaction::resource::external::disassociate::Request message{ resources.at( 0).handle()};
         ...
         {
            auto reply = common::communication::device::receive< common::message::transaction::resource::external::disassociate::Reply>( resources.at( 0).device);
