...
namespace casual
{
   namespace broker
   {
      TEST( casual_broker_state, admin_services)
      {
      ...
      TEST( casual_broker_state, advertise_empty_invalid_local__expect_no_op)
      {
         common::unittest::Trace trace;
      ...
      TEST( casual_broker_state, advertise_empty_invalid_remote__expect_no_op)
      {
         common::unittest::Trace trace;
      ...
      TEST( casual_broker_state, advertise_local_service__expect_service_and_instance_added)
      {
         common::unittest::Trace trace;
      ...
      TEST( casual_broker_state, advertise_local_service__unadvertise___expect__service_instance_relation__removed)
      {
         common::unittest::Trace trace;
      ...
      TEST( casual_broker_state, advertise_10_local_services__expect_relation_from_instance_to_all_services)
      {
         common::unittest::Trace trace;
      ...
      TEST( casual_broker_state, advertise_10_local_services__unadvertise_2__expect_relation_from_instance_to_all_services_but_2)
      {
         common::unittest::Trace trace;
