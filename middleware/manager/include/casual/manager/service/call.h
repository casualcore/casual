...
namespace casual
{
   namespace manager::service
   {
      namespace detail
      {
         ...
         auto call( D&& device, std::string_view service, Ts&&... arguments)
         {
            auto correlation = [&]()
            {
            ...
            return common::communication::ipc::receive< common::message::service::call::Reply>( correlation);
         }
      ...
      template< typename D, typename... Ts> 
      void call( D&& device, std::string_view service, Ts&&... arguments)
      {
         detail::call( std::forward< D>( device), service, std::forward< Ts>( arguments)...);
      }
      ...
      {
         auto reply = detail::call( std::forward< D>( device), service, std::forward< Ts>( arguments)...);
