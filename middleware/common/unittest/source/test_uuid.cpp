...
namespace casual
{
   ...
   namespace common
   {
      ...
      TEST( common_uuid, two_uuid__expect_unique)
      {
      ...
      TEST( common_uuid, one_uuid__expect_equal)
      {
         common::unittest::Trace trace;
      ...
      TEST( common_uuid, two_uuid__expect_equal)
      {
         common::unittest::Trace trace;
      ...
      TEST( common_uuid, default_constructed__expect_equal_to_empty)
      {
         common::unittest::Trace trace;
      ...
      TEST( common_uuid, getString__expect_32B)
      {
         common::unittest::Trace trace;
      ...
      TEST( common_uuid, default_constructed__uuid_string__expect_00000000000000000000000000000000)
      {
         common::unittest::Trace trace;
      ...
      TEST( common_uuid, ctor_55d9d19db80b49ac98188deef6fa0d4a__copy_ctor__expect_equal_string)
      {
         common::unittest::Trace trace;
