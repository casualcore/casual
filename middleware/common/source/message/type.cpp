   ...
   namespace common::message
   {
      std::ostream& operator << ( std::ostream& out, Type value)
      {
         switch( value)
         {
            ...
            case Type::domain_discovery_api_provider_registration_request: return out << "domain_discovery_api_provider_registration_request";
            case Type::domain_discovery_api_provider_registration_reply: return out << "domain_discovery_api_provider_registration_reply";
            case Type::domain_discovery_api_request: return out << "domain_discovery_api_request";
            case Type::domain_discovery_api_reply: return out << "domain_discovery_api_reply";
            case Type::domain_discovery_api_rediscovery_request: return out << "domain_discovery_api_rediscovery_request";
            case Type::domain_discovery_api_rediscovery_reply: return out << "domain_discovery_api_rediscovery_reply";
            case Type::domain_discovery_needs_request: return out << "domain_discovery_needs_request";
            case Type::domain_discovery_needs_reply: return out << "domain_discovery_needs_reply";
            ...
            case Type::domain_discovery_topology_update: return out << "domain_discovery_topology_update";
