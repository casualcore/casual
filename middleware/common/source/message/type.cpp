   ...
   namespace common::message
   {
      std::ostream& operator << ( std::ostream& out, Type value)
      {
         switch( value)
         {
            ...
            case Type::domain_discovery_inbound_registration: return out << "domain_discovery_inbound_registration";
            case Type::domain_discovery_outbound_registration: return out << "domain_discovery_outbound_registration";
            case Type::domain_discovery_outbound_request: return out << "domain_discovery_outbound_request";
            case Type::domain_discovery_outbound_reply: return out << "domain_discovery_outbound_reply";
            case Type::domain_discovery_rediscovery_request: return out << "domain_discovery_rediscovery_request";
            case Type::domain_discovery_rediscovery_reply: return out << "domain_discovery_rediscovery_reply";
