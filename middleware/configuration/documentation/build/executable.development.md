...
Defines which `xa` resources to link and use at runtime. A name **has** to be provided for each 
...
resources and such, then invoke the `entrypoint`, and all the control is left to the user. As if 
