...
namespace casual
{
   namespace gateway::group::tcp
   {
      ...
      private:
         ...
         common::Uuid send( common::communication::select::Directive& directive, complete_type&& complete);
      ...
      struct External
      {
         ...
         inline std::optional< Configuration> remove( 
            common::communication::select::Directive& directive, 
            common::strong::file::descriptor::id descriptor)
         {
      ...
      void connect( State& state, C& connections)
      {
         ...
         auto connected = [&state]( auto& connection)
         {
            ...
            catch( ...)
            {
               ...
               common::log::line( common::log::category::warning, code, " connect severely failed for address: '", connection.configuration.address, "' - action: try later");
            }
