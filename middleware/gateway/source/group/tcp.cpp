...
namespace casual
{
   namespace gateway::group::tcp
   {
      ...
      namespace connector
      {
         ...
         {
            auto path = string::compose( process::directory(), "/casual-gateway-group-tcp-connector");
      ...
      Uuid Connection::send( common::communication::select::Directive& directive, complete_type&& complete)
      {
