...
def LinkIsolatedUnittest(name,objectfiles,libraries): return porcelain().LinkIsolatedUnittest(name,objectfiles,libraries)
def LinkDependentUnittest( name, objectfiles, libraries, resources = None): return porcelain().LinkDependentUnittest( name, objectfiles, libraries, resources)
